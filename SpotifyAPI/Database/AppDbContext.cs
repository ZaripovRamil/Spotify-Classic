...
public class AppDbContext : IdentityDbContext<User>
{
    ...
    private static void PopulateDb(ModelBuilder modelBuilder)
    {
        ...
        var taleofTsarSaltanAlbum = new Album("The Tale of Tsar Saltan", rimskyKorsakovAuthor, AlbumType.Album, 1900,
            "cdbc9b43-ee1b-4a64-8b2d-d579522ea84f");
        ...
        var grandesEtudesDePaganiniAlbum = new Album("Grandes études de Paganini", lisztAuthor, AlbumType.Album, 1851,
            "864239f6-65c5-440f-8326-213b3b25693f");
        ...
        var violinConcertoNo2Album = new Album("Violin Concerto No. 2", paganiniAuthor, AlbumType.Album, 1826,
            "493afb2c-eb2a-4eab-9e4e-6585eb9924ae");
        ...
        var storm = new Track("Summer - Storm", fourSeasonsAlbum,
            "7c561b1e-3070-4e83-b71a-2fd7a69fa040"); // classic, instrumental
        var spring =
            new Track("Spring", fourSeasonsAlbum, "9f1d7cfd-53c6-478f-82e2-db737d1b9ecf"); // classic, instrumental
        var moonlight =
            new Track("Moonlight Sonata", moonlightAlbum,
        ...
        var fantasieImpromptu = new Track("Fantaisie Impromptu", fantaisieImpromptuAlbum,
            "4180556e-5365-4b9c-aa72-a47241346855"); // classic, instrumental
        var flightOfBumblemee = new Track("Flight of the Bumblebee", taleofTsarSaltanAlbum,
            "4180556e-5365-4b9c-aa72-a47241346855"); // classic, instrumental
        var laCampanellaLiszt = new Track("La Campanella", grandesEtudesDePaganiniAlbum,
            "864239f6-65c5-440f-8326-213b3b25693f"); // classic, instrumental
        var loveDream =
            new Track("Love Dream", liebestraumAlbum, "44f268c1-3e94-4d05-8ccb-17c2e77b538d"); // classic, instrumental
        var marriegeDAmour =
            new Track("Marriage d'Amour", lettreAMaMereAlbum,
                "15fa89e4-7777-4330-b32e-62172cd398c0"); // newage, instrumental
        var lacrimosa = new Track("Lacrimosa", requiemMozartAlbum, "9d0a67df-6fb4-4fac-b670-49a5f590beb7"); // classic
        var marriageOfFigaro = new Track("Marriage of Figaro - Overture", marriageOfFigaroAlbum,
            "15fa89e4-7777-4330-b32e-62172cd398c0"); // classic, instrumental
        var laCampanellaPaganini =
            new Track("La Campanella", violinConcertoNo2Album,
                "493afb2c-eb2a-4eab-9e4e-6585eb9924ae"); // classic, instrumental
        var rickroll = new Track("Never gonna give you up", wheneverYouNeedSomebodyAlbum,
            "572cc6a2-a5ba-47f5-8819-8330770cf8b5"); // pop
        var valseSentimental =
            new Track("Valse Sentimental", valseScherzoAlbum,
                "36febf49-1c49-4b69-8084-73ebce69040a"); // classic, instrumental
        var turkishMarch =
            new Track("Turkish March", pianoSonataNo11Album,
                "b26e8131-28bf-4ae9-842b-33b3d639b08e"); // classic, instrumental
        var hungarianRhapsodyNo2 = new Track("Hungarian Rhapsody No. 2", hungarianRhapsodiesAlbum,
