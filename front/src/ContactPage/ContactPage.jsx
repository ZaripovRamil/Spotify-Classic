...
const coordinates = [[55.792139, 49.122135]];
    ...
    <main className="main-page">
      ...
      <div className="contacts">
        <div className="contact_one">
          <p>Если вы хотите лично увидеть команду разработчиков:</p>
          <div className="map">
            <YMaps>
              <Map width="500px" height="300px" defaultState={mapData}>
                {coordinates.map((coordinate) => (
                  <Placemark
                    ...
                    properties={{
                      ...
                      balloonContentHeader: "Команда доткек и боль",
                      balloonContentBody: "Мы сидим здесь",
        ...
        <div className="contact_two">
          <ul class="contacts__list">
            ...
            <li>
              <a href="mailto:support@Spotify-classic.com">
                support@Spotify-classic.com
              </a>
            </li>
          </ul>
          <div class="contacts__social">
            {/* discord */}
            <a
              href="https://discord.gg/Bumgeqc4"
              target="_blank"
              rel="noreferrer"
            >
            ...
            {/* vk */}
            <a href="https://vk.com/itis_kfu" target="_blank" rel="noreferrer">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            ...
            {/* telegram */}
            <a href="https://t.me/kfu_itis" target="_blank" rel="noreferrer">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
