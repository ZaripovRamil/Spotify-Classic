...
export const PageBuilder = ({ component }) => {
    ...
    const [tracksList, setTracksList] = useState(JSON.parse(localStorage.getItem('player-tracklist')));
    const [playerConf, setPlayerConf] = useState(JSON.parse(localStorage.getItem('player-config')));
